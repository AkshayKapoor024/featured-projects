export default function SmallInput({ type = 'text', label, placeholder , value , onChange , name}) {
  ...
  return (
   <div className="grid grid-cols-7 items-center gap-2 h-24">
      <label className="col-span-7 2xl:col-span-3 text-center text-xl font-semibold text-gray-600">{label}</label>
      <div className="flex mx-2 items-center  col-span-5 2xl:mx-0 2xl:col-span-3 ">
        <input
          ...
          className="input input-info focus:ring-1 focus:ring-indigo-200 bg-white w-[100vw] sm:w-[600px] 2xl:w-[700px] validator  text-gray-600"
          value={value}
          onChange={onChange}
          name={name}
        />
