      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <div className="w-full 2xl:h-32 flex flex-col justify-center items-center">
            <label
              htmlFor="username"
              className="h-10 w-full text-xl lg:h-20 lg:text-3xl 2xl:w-[700px] flex p-4 2xl:text-2xl font-semibold 2xl:justify-center items-center"
            >
              Username
            </label>
            <input
            ...
            />
            <div className="validator-hint text-sm text-red-500 mt-1 lg:text-xl">
          ...
          <div className="w-full 2xl:h-32 flex flex-col justify-center items-center">
            ...
            />
            <div className="validator-hint text-sm lg:text-xl text-red-500 mt-1">
              Please enter a valid password
            </div>
          </div>

          {/* Submit Button */}
          <div className=" w-[330px] md:w-[700px] md:text-lg lg:text-2xl lg:w-[900px] lg:h-20 2xl:w-[900px] flex flex-col justify-center items-center">
